...
class MPCE_CFA_Mailer{
    ...
    public function __construct( $from, $to, $subj, $replyto = '' ){
        $this->from = $from;
        $this->to = $to;
...
function mpce_cfa_contact_ajax(){
    ...
    $to = ($to === '') ? 'saraquispee@gmail.com' : $to;
    $from = ($from === '') ? 'saraquispee@gmail.com' : $from;
    ...
    $mailer = new MPCE_CFA_Mailer( $from, $to, $subj, $replyto );
